...
class CongratesCanvas extends PureComponent {
    ...
    componentWillMount() {
        ...
        window.addEventListener("resize", window.resizeWindow, !1);
        window.onload = function () {
            return setTimeout(window.resizeWindow, 0);
        };
        range = function (a, b) {
...
export default CongratesCanvas